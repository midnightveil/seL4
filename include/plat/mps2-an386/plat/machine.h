...
extern char _zbtsram1_start[1], _zbtsram1_end[1];
extern char _zbtsram2_start[1], _zbtsram2_end[1];

/* PHYSICAL MEMORY */
static const p_region_t BOOT_RODATA avail_p_regs[] = {
    { .start = (paddr_t)&_zbtsram1_start, .end = (paddr_t)&_zbtsram1_end },
    { .start = (paddr_t)&_zbtsram2_start, .end = (paddr_t)&_zbtsram2_end }
};
